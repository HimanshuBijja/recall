    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <h1 className="cinematic-headline text-[10vw] sm:text-[8vw] md:text-[5vw] leading-[0.85] font-display font-bold tracking-tight mb-1" data-text="CARDS">
            CARDS
          </h1>
          ...
          {filtered.map((c) => {
            ...
            return (
              ...
              >
                ...
                {(c.source || (c.referenceImages && c.referenceImages.length > 0)) && (
                  <div onClick={(e) => e.stopPropagation()}>
                    <CardFrame
                      url={c.source?.screenshotUrl}
                      urls={c.referenceImages}
                      source={c.source}
                    />
                  </div>
                )}
